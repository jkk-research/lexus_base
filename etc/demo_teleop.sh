...
screen -d -m -S view_zed_cam bash -c 'rosrun rqt_image_view rqt_image_view /zed_node/left/image_rect_color'
#screen -d -m -S view_zed_cam bash -c 'rosrun rqt_image_view rqt_image_view /zed_node/left/image_rect_color/compressed'
